...
class _ActionDetailScreenState extends State<ActionDetailScreen>
  ...
  Future<void> _updateSpeed(double delta) async {
    final newRate = (_speechRate + delta).clamp(0.2, 1.0);
    setState(() {
      _speechRate = newRate;
      _isPlaying = false;
    });
  ...
  String get _speedLabel {
    if (_speechRate <= 0.3) return '0.5x';
    if (_speechRate <= 0.45) return '1x';
    if (_speechRate <= 0.6) return '1.5x';
    if (_speechRate <= 0.75) return '2x';
    return '2.5x';
  }
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  4.verticalSpace,
                                  Text(
                                    'Tap to ${_isPlaying ? 'stop' : 'hear'} your cosmic essence',
                                    style: TextStyle(
